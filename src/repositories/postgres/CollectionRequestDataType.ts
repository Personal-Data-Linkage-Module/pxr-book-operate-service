...
/**
 * データ提供契約収集依頼データ種テーブルエンティティ
 */
@Entity('collection_request_data_type')
export default class CollectionRequestDataType {
    /**
     * ID
     */
    ...
    constructor (entity?: {}) {
        if (entity) {
            const entityName = 'collection_request_data_type_';
