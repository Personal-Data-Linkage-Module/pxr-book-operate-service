...
export default class PostShareByTempShareCodeRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        // パラメータバリデーション
        await transformAndValidate(PostShareByTempShareCodeReqDto, request.body);
        next();
    }
}
