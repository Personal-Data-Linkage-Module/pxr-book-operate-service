...
import PostThingByUserIdByEventIdReqDto from '../dto/PostThingByUserIdByEventIdReqDto';
...
export default class PostThingAddRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        await transformAndValidate(PostThingByUserIdByEventIdReqDto, request.body);
        next();
    }
